...
public enum Kind {
    ...
    private static final Set<Kind> EXPRESSIONS = Set.of(BINARY_OP, INTEGER_LITERAL, BOOLEAN_LITERAL, VAR_REF_EXPR, NEW_CLASS, FUNCTION_CALL, NEGATION, NEW_ARRAY, ARRAY_ACCESS, ARRAY_INIT);
